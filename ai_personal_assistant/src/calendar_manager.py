...
class CalendarManager:
    ...
    def __init__(self):
        self.timezone = pytz.timezone(os.getenv('CALENDAR_TIMEZONE', 'Asia/Kolkata'))
        self.service = None
        ...
        try:
            ...
            if not creds or not creds.valid:
                if os.path.exists('credentials.json'):
                    ...
                    st.warning("credentials.json not found - using local storage")
                    return False
    ...
    def create_event(self, event_data: dict) -> dict:
        ...
        event = {
            ...
            'description': f"AI Assistant • Priority: {event_data.get('priority', 'medium')} • Category: {event_data.get('category', 'general')}",
            'start': {
        ...
        # Try Google Calendar, fallback to local
    ...
    def parse_time(self, time_str: str) -> datetime:
        ...
        if 'pm' in time_str or 'am' in time_str:
            time_part = time_str.split()[-1]  # Get last word with time
